...
function useStyleRegister(info, styleFn) {
  ...
  return function(node2) {
    ...
    if (!ssrInline || isMergedClientSide || !defaultCache) {
      ...
      var _ref6;
      styleNode = React6.createElement("style", _extends({}, (_ref6 = {}, _defineProperty(_ref6, ATTR_TOKEN, cachedTokenKey), _defineProperty(_ref6, ATTR_MARK, cachedStyleId), _ref6), {
...
var LayoutContext = React31.createContext({
  siderHook: {
    addSider: () => null,
    removeSider: () => null
  }
...
var SiderContext = React32.createContext({});
...
var Sider = React32.forwardRef((props, ref) => {
  const {
  ...
  const {
    siderHook
  } = (0, import_react14.useContext)(LayoutContext);
  const [collapsed, setCollapsed] = (0, import_react14.useState)("collapsed" in props ? props.collapsed : defaultCollapsed);
  const [below, setBelow] = (0, import_react14.useState)(false);
  ...
  const responsiveHandlerRef = (0, import_react14.useRef)();
  ...
  const renderSider = () => {
    ...
    const zeroWidthTrigger = parseFloat(String(collapsedWidth || 0)) === 0 ? React32.createElement("span", {
      onClick: toggle,
      className: (0, import_classnames2.default)(`${prefixCls}-zero-width-trigger`, `${prefixCls}-zero-width-trigger-${reverseArrow ? "right" : "left"}`),
      style: zeroWidthTriggerStyle
    }, trigger || React32.createElement(BarsOutlined_default, null)) : null;
    const iconObj = {
      expanded: reverseArrow ? React32.createElement(RightOutlined_default, null) : React32.createElement(LeftOutlined_default, null),
      collapsed: reverseArrow ? React32.createElement(LeftOutlined_default, null) : React32.createElement(RightOutlined_default, null)
    };
    const status = collapsed ? "collapsed" : "expanded";
    const defaultTrigger = iconObj[status];
    const triggerDom = trigger !== null ? zeroWidthTrigger || React32.createElement("div", {
    ...
    const siderCls = (0, import_classnames2.default)(prefixCls, `${prefixCls}-${theme}`, {
      [`${prefixCls}-collapsed`]: !!collapsed,
      [`${prefixCls}-has-trigger`]: collapsible && trigger !== null && !zeroWidthTrigger,
      [`${prefixCls}-below`]: !!below,
      [`${prefixCls}-zero-width`]: parseFloat(siderWidth) === 0
    }, className);
    return React32.createElement("aside", Object.assign({
      className: siderCls
    }, divProps, {
      style: divStyle,
      ref
  ...
  return React32.createElement(SiderContext.Provider, {
    value: contextValue
  }, renderSider());
});
if (true) {
...
//# sourceMappingURL=chunk-7VEPFYKI.js.map
